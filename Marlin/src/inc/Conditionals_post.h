...
//
#define HAS_ADC_TEST(P) (PIN_EXISTS(TEMP_##P) && TEMP_SENSOR_##P != 0 && DISABLED(HEATER_##P##_USES_MAX6675) && DISABLED(HEATER_##P##_USES_ADS1118))
...
#define HAS_TEMP_HOTEND   ((HAS_TEMP_ADC_0 || ENABLED(HEATER_0_USES_MAX6675) || ENABLED(HEATER_0_USES_ADS1118)) && HOTENDS)
